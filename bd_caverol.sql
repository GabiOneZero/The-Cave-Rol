...
-- Tiempo de generación: 16-06-2022 a las 05:33:33
...
CREATE TABLE IF NOT EXISTS `articulos` (
  ...
  `stock` int NOT NULL,
  `imagen` varchar(80) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL DEFAULT 'no_imagen.jpg',
...
INSERT INTO `articulos` (`articulo_id`, `categoria_id`, `nombre`, `precio`, `descripcion`, `stock`, `imagen`) VALUES
...
CREATE TABLE IF NOT EXISTS `categorias` (
  ...
  `descripción` varchar(80) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
...
INSERT INTO `categorias` (`categoria_id`, `nombre`, `descripción`) VALUES
...
INSERT INTO `clientes` (`cliente_id`, `usuario_id`, `fecha_registro`) VALUES
(1, 1, '2022-02-08'),
(2, 2, '2021-10-13');
...
CREATE TABLE IF NOT EXISTS `compras` (
  ...
  KEY `compras_ibfk_1` (`formapago_id`),
...
--
-- Estructura de tabla para la tabla `detallescestas`
--

DROP TABLE IF EXISTS `detallescestas`;
CREATE TABLE IF NOT EXISTS `detallescestas` (
  `cesta_id` int NOT NULL,
  `articulo_id` int NOT NULL,
  `cantidad` int NOT NULL,
  PRIMARY KEY (`cesta_id`,`articulo_id`),
  KEY `detallescestas_ibfk_2` (`articulo_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
CREATE TABLE IF NOT EXISTS `detallescompras` (
  ...
  KEY `detallescompras_ibfk_1` (`compra_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
CREATE TABLE IF NOT EXISTS `direcciones` (
  ...
  `detalles` varchar(80) CHARACTER SET utf8 COLLATE utf8_spanish_ci DEFAULT NULL,
...
INSERT INTO `direcciones` (`direccion_id`, `usuario_id`, `calle`, `numero`, `ciudad`, `provincia`, `cp`, `pais`, `detalles`) VALUES
(1, 1, 'Buckhannan Avenue', 2977, 'Syracuse', 'NY', 13206, 'EEUU', NULL),
(2, 2, 'Bellavista', 49, 'Illueca', 'Zaragoza', 50250, 'España', NULL),
(3, 3, 'Chausseestr.', 17, 'Borstel', 'Hohenraden', 25494, 'Alemania', NULL),
(4, 4, 'Strada Statale', 7, 'Pray Biellese', 'BI', 13867, 'Italia', NULL),
(5, 8, 'adfadfa', 78, 'adfadfaf', 'adfadf', 9846, 'adfadf', NULL),
(6, 9, 'adfadfa', 78, 'adfadfaf', 'adfadf', 9846, 'adfadf', NULL),
(7, 10, 'adfadfa', 78, 'adfadfaf', 'adfadf', 9846, 'adfadf', NULL),
(8, 11, 'adfadfa', 78, 'adfadfaf', 'adfadf', 9846, 'adfadf', NULL),
(9, 12, 'adfadfa', 78, 'adfadfaf', 'adfadf', 9846, 'adfadf', NULL),
(10, 13, 'adfadfa', 78, 'adfadfaf', 'adfadf', 9846, 'adfadf', NULL);
...
CREATE TABLE IF NOT EXISTS `empleados` (
  ...
  KEY `empleados_ibfk_1` (`usuario_id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
INSERT INTO `empleados` (`empleados_id`, `usuario_id`, `puesto`, `dni`) VALUES
...
CREATE TABLE IF NOT EXISTS `formaspago` (
  `formaspago_id` int NOT NULL AUTO_INCREMENT,
  `nombre` varchar(50) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  `descripcion` varchar(80) COLLATE utf8_spanish_ci DEFAULT NULL,
  `sobrecargo` decimal(10,0) NOT NULL,
  PRIMARY KEY (`formaspago_id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
INSERT INTO `formaspago` (`formaspago_id`, `nombre`, `descripcion`, `sobrecargo`) VALUES
...
CREATE TABLE IF NOT EXISTS `turnos` (
  ...
  `dia` int NOT NULL,
  `hora` enum('turno_tarde','turno_mañana') CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
...
INSERT INTO `turnos` (`turno_id`, `empleado_id`, `dia`, `hora`) VALUES
(1, 3, 1, 'turno_mañana'),
(2, 3, 2, 'turno_tarde'),
(3, 3, 3, 'turno_tarde'),
(4, 3, 4, 'turno_tarde'),
...
CREATE TABLE IF NOT EXISTS `usuarios` (
  ...
  `apellido1` varchar(30) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  `apellido2` varchar(30) CHARACTER SET utf8 COLLATE utf8_spanish_ci DEFAULT NULL,
  `clave` varchar(32) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
...
INSERT INTO `usuarios` (`usuario_id`, `nombre`, `apellido1`, `apellido2`, `clave`, `email`, `telefono`, `fecha_nacimiento`) VALUES
...
ALTER TABLE `articulos`
  ADD CONSTRAINT `articulos_ibfk_1` FOREIGN KEY (`categoria_id`) REFERENCES `categorias` (`categoria_id`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `cestas`
--
ALTER TABLE `cestas`
  ADD CONSTRAINT `cestas_ibfk_1` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`usuario_id`) ON DELETE RESTRICT ON UPDATE RESTRICT;

--
-- Filtros para la tabla `clientes`
--
ALTER TABLE `clientes`
  ADD CONSTRAINT `clientes_ibfk_1` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`usuario_id`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `compras`
--
ALTER TABLE `compras`
  ADD CONSTRAINT `compras_ibfk_1` FOREIGN KEY (`formapago_id`) REFERENCES `formaspago` (`formaspago_id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `compras_ibfk_2` FOREIGN KEY (`direccion_id`) REFERENCES `direcciones` (`direccion_id`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `detallescestas`
--
ALTER TABLE `detallescestas`
  ADD CONSTRAINT `detallescestas_ibfk_1` FOREIGN KEY (`cesta_id`) REFERENCES `cestas` (`cesta_id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `detallescestas_ibfk_2` FOREIGN KEY (`articulo_id`) REFERENCES `articulos` (`articulo_id`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `detallescompras`
--
ALTER TABLE `detallescompras`
  ADD CONSTRAINT `detallescompras_ibfk_1` FOREIGN KEY (`compra_id`) REFERENCES `compras` (`compra_id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `detallescompras_ibfk_2` FOREIGN KEY (`articulo_id`) REFERENCES `articulos` (`articulo_id`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `direcciones`
--
ALTER TABLE `direcciones`
  ADD CONSTRAINT `direcciones_ibfk_1` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`usuario_id`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `empleados`
--
ALTER TABLE `empleados`
  ADD CONSTRAINT `empleados_ibfk_1` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`usuario_id`) ON UPDATE CASCADE;

--
-- Filtros para la tabla `turnos`
--
ALTER TABLE `turnos`
  ADD CONSTRAINT `turnos_ibfk_1` FOREIGN KEY (`empleado_id`) REFERENCES `empleados` (`empleados_id`) ON UPDATE CASCADE;
COMMIT;
